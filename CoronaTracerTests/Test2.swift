/* Pulls WHO data, then distinguishes to different arrays of confirmed, fatality (death), recovery, 
grabs by country_region,state,creates string variables, then sums up total counts for each category */
